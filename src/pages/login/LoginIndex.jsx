      ...
      <div className='newAccWrapper'>
        ...
        <form className='newAccForm'>
          <div className='newAccNames'>
            <input type="text" className='newAccInputsNames' id="name" name="name" placeholder='First Name' />
            <input type="text" className='newAccInputsNames' id="lastname" name="lastname" placeholder='Last Name' />
          </div>
          <input type="email" className='newAccInputs' id="emailRegistration" name="email" placeholder='Mobile number or email' />
          <input type="password" className='newAccInputs' id="passwordRegistration" name="password" placeholder='New Password' />
          <span className='newAccOptions'>
            Date of birth
            <AiFillQuestionCircle />
          </span>
          <div className='newAccBirthday'>
            <select className='newAccFormSelection' id="day" name='birthdayDay' title='Day'>
              <option value='1'>1</option>
            </select>
            <select className='newAccFormSelection' id="month" name='birthdayMonth' title='Month'>
              <option value='1'>Aug</option>
            </select>
            <select className='newAccFormSelection' id="year" name='birthdayYear' title='Year'>
          ...
          <p className='newAccLittleLetter'>
            People using our service may have uploaded your contact information to Facebook. <span className='falseLinkAzul'>Learn more.</span>
            <br /><br />
            By clicking "Sign Up," you agree to our <span className='falseLinkAzul'>Terms</span>, <span className='falseLinkAzul'>Privacy Policy</span>, and <span className='falseLinkAzul'>Cookies Policy</span>. You may receive SMS notifications, which you can turn off at any time.
          </p>
